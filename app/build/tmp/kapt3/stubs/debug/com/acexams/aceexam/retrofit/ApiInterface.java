...
public abstract interface ApiInterface {
    ...
    @org.jetbrains.annotations.NotNull()
    @retrofit2.http.POST(value = "exam-of-day")
    public abstract retrofit2.Call<com.acexams.aceexam.activity.modal.examoftheday> examof(@org.jetbrains.annotations.NotNull()
    @retrofit2.http.Header(value = "Authorization")
    java.lang.String token);
    ...
    @org.jetbrains.annotations.NotNull()
    @retrofit2.http.POST(value = "over-all-progress-subject-wise")
    @retrofit2.http.FormUrlEncoded()
    public abstract retrofit2.Call<com.acexams.aceexam.activity.modal.OverAllProcessResponse> overalll(@org.jetbrains.annotations.Nullable()
    @retrofit2.http.Header(value = "Authorization")
    java.lang.String token, @org.jetbrains.annotations.Nullable()
    @retrofit2.http.Field(value = "user_id")
    java.lang.String user_id);
